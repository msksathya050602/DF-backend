...
export class CustomerMigration1773918917756 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."order_items_itemstatus_enum" AS ENUM('RECEIVED', 'PROCESSING', 'DONE', 'DELIVERED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_paymentstatus_enum" AS ENUM('PENDING', 'PAID', 'PARTIAL', 'REFUNDED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "pricing" ADD CONSTRAINT "FK_593283e7d1406fc51668e05dd11" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "pricing" ADD CONSTRAINT "FK_ceee2a0f75732e11a00899e4252" FOREIGN KEY ("service_id") REFERENCES "services"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_17b723da2c12837f4bc21e33398" FOREIGN KEY ("branch_id") REFERENCES "branches"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
